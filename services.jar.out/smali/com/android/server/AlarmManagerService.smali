...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/AlarmManagerService;->showSDF:Ljava/text/SimpleDateFormat;
...
.method setImpl(IJJJLandroid/app/PendingIntent;ZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;)V
    ...
    .line 753
    :cond_0
    const-string v8, "persist.service.powersave.logs"
    ...
    sput-boolean v8, Lcom/android/server/AlarmManagerService;->showLOGV:Z

    .line 755
    move-wide/from16 v32, p2

    .line 756
    .local v32, "triggerRealTime":J
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J
    ...
    iget-object v9, v0, Lcom/android/server/AlarmManagerService;->showSDF:Ljava/text/SimpleDateFormat;
    ...
    invoke-static {v8}, Lcom/android/server/AlarmManagerService;->timerLog(Ljava/lang/String;)V

    .line 779
    .end local v26    # "currentTime":J
    .end local v32    # "triggerRealTime":J
    :goto_1
    ...
    .restart local v32    # "triggerRealTime":J
    :cond_7
    new-instance v8, Ljava/lang/StringBuilder;
