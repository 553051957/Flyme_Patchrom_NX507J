...
.method private updatePowerState()V
    ...
    iget v4, v14, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->dozeScreenBrightness:I
    ...
    invoke-direct {v0, v13, v8}, Lcom/android/server/display/DisplayPowerController;->animateScreenStateChange(IZ)V
    ...
    .line 683
    :cond_1d
    const-string v14, "persist.sys.lcd.ramprate.fast"
    ...
    .line 685
    .local v9, "rampRateFast":I
    const-string v14, "persist.sys.lcd.ramprate.slow"
    ...
    .line 688
    .local v10, "rampRateSlow":I
    if-eqz v12, :cond_2c

    .end local v10    # "rampRateSlow":I
    :goto_c
    move-object/from16 v0, p0

    invoke-direct {v0, v4, v10}, Lcom/android/server/display/DisplayPowerController;->animateScreenBrightness(II)V

    .line 698
    .end local v9    # "rampRateFast":I
    :cond_1e
    :goto_d
    move-object/from16 v0, p0
    ...
    .restart local v9    # "rampRateFast":I
    .restart local v10    # "rampRateSlow":I
    :cond_2c
    move v10, v9
    ...
    invoke-direct {v0, v4, v14}, Lcom/android/server/display/DisplayPowerController;->animateScreenBrightness(II)V
