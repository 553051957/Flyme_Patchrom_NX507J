...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/Session;Landroid/view/IWindow;Lcom/android/server/wm/WindowToken;Lcom/android/server/wm/WindowState;IILandroid/view/WindowManager$LayoutParams;ILcom/android/server/wm/DisplayContent;)V
    ...
    invoke-interface {v10, p0}, Lcom/android/server/wm/IWmSmartShowFuncs;->createSmartShowData(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public computeFrameLw(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-direct {v0, v15, v1}, Lcom/android/server/wm/WindowState;->getStackBounds(Lcom/android/server/wm/TaskStack;Landroid/graphics/Rect;)V
...
.method getStack()Lcom/android/server/wm/TaskStack;
    ...
    const-string v5, "getStack: mStack null for task="
    ...
    const-string v5, " couldn\'t find taskId="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, v2, Lcom/android/server/wm/AppWindowToken;->groupId:I
...
.method reportResized()V
    ...
    .line 1468
    .local v10, "curConfiguration":Landroid/content/res/Configuration;
    :try_start_0
    ...
    iget-object v10, v0, Lcom/android/server/wm/WindowManagerService;->mCurConfiguration:Landroid/content/res/Configuration;
    ...
    invoke-virtual {p0, v10}, Lcom/android/server/wm/WindowState;->setConfiguration(Landroid/content/res/Configuration;)V
    ...
    iget-object v13, v0, Lcom/android/server/wm/WindowManagerService;->mH:Lcom/android/server/wm/WindowManagerService$H;
    ...
    invoke-virtual {v13, v0}, Lcom/android/server/wm/WindowManagerService$H;->post(Ljava/lang/Runnable;)Z
    ...
    invoke-interface {v0, p0}, Lcom/android/server/wm/IWmSmartShowFuncs;->getConfigurationLocked(Lcom/android/server/wm/WindowState;)Landroid/content/res/Configuration;
    ...
    iput-boolean v12, p0, Lcom/android/server/wm/WindowState;->mOrientationChanging:Z
    ...
    iget-wide v12, v12, Lcom/android/server/wm/WindowManagerService;->mDisplayFreezeTime:J
