...
.field private static final SIX_HOURS_IN_MILLIS:J = 0x1499700L
...
.method static synthetic access$000(Landroid/app/NotificationDateTimeView;)J
    .locals 2
    .param p0, "x0"    # Landroid/app/NotificationDateTimeView;

    .prologue
    .line 50
    iget-wide v0, p0, Landroid/app/NotificationDateTimeView;->mUpdateTimeMillis:J
...
.method update()V
    ...
    .line 113
    .local v21, "time":Ljava/util/Date;
    ...
    .line 134
    cmp-long v26, v16, v12

    if-ltz v26, :cond_1

    cmp-long v26, v16, v10
    ...
    .end local v22    # "twelveHoursAfter":J
    :goto_4
    ...
    .line 220
    .end local v24    # "twelveHoursBefore":J
    :goto_5
    invoke-static {}, Ljava/lang/System;->nanoTime()J
    ...
    .restart local v22    # "twelveHoursAfter":J
    .restart local v24    # "twelveHoursBefore":J
    :cond_4
    const/4 v4, 0x1
    ...
    const-string/jumbo v28, "unknown display value: "
    ...
    .line 171
    .local v8, "hours":I
    rem-int/lit8 v14, v9, 0x3c

    .line 172
    .local v14, "minutesOnHour":I
    if-nez v8, :cond_9
    ...
    .line 174
    invoke-virtual/range {p0 .. p0}, Landroid/app/NotificationDateTimeView;->getContext()Landroid/content/Context;
