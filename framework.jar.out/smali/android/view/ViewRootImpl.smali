...
.field private static final MSG_DISPATCH_EXTRACT_SMART_CONTENT:I = 0x64
...
.field private static final SMART_CONTENT_EXTRACT_CMD:Ljava/lang/String; = "PM_SMART_CONTENT"
...
.method static synthetic access$700(Landroid/view/ViewRootImpl;ILandroid/graphics/Rect;)V
    .locals 0
    .param p0, "x0"    # Landroid/view/ViewRootImpl;
    .param p1, "x1"    # I
    ...
    .prologue
    .line 108
    invoke-direct {p0, p1, p2}, Landroid/view/ViewRootImpl;->handleExtractSmartContent(ILandroid/graphics/Rect;)V
...
.method private handleExtractSmartContent(ILandroid/graphics/Rect;)V
    .locals 2
    .param p1, "id"    # I
    ...
    invoke-interface {v0, v1, p1, p2}, Landroid/content/ISmartShowContext;->doExtractSmartContent(Landroid/view/View;ILandroid/graphics/Rect;)V
...
.method private performTraversals()V
    ...
    .line 1296
    :cond_5
    new-instance v55, Landroid/graphics/Point;

    invoke-direct/range {v55 .. v55}, Landroid/graphics/Point;-><init>()V

    .line 1297
    .local v55, "size":Landroid/graphics/Point;
    move-object/from16 v0, p0
    ...
    .line 1323
    .end local v55    # "size":Landroid/graphics/Point;
    :cond_6
    :goto_3
    move-object/from16 v0, p0
    ...
    .line 1402
    .restart local v55    # "size":Landroid/graphics/Point;
    move-object/from16 v0, p0
    ...
    .restart local v54    # "resizeMode":I
    :cond_25
    if-nez v54, :cond_26
    ...
    .line 1577
    .local v50, "overscanInsetsChanged":Z
    :goto_e
    move-object/from16 v0, p0
    ...
    .line 1583
    .local v57, "stableInsetsChanged":Z
    :goto_11
    if-eqz v32, :cond_37
    ...
    .line 1736
    .end local v50    # "overscanInsetsChanged":Z
    .end local v57    # "stableInsetsChanged":Z
    ...
    .restart local v53    # "relayoutResult":I
    :cond_44
    const/16 v45, 0x0
    ...
    .line 1577
    .restart local v50    # "overscanInsetsChanged":Z
    :cond_47
    const/16 v32, 0x0
    ...
    .line 1695
    .restart local v57    # "stableInsetsChanged":Z
    :catch_0
    move-exception v34
...
.method public dispatchExtractSmartContent(ILandroid/graphics/Rect;)V
    .locals 4
    .param p1, "id"    # I
    .param p2, "area"    # Landroid/graphics/Rect;
    ...
    invoke-virtual {v1, v2, p1, v3, p2}, Landroid/view/ViewRootImpl$ViewRootHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
